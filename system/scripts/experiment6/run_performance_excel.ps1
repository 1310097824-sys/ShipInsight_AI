...
& $Python (Join-Path $PSScriptRoot "experiment6_excel_runner.py") --suite performance --output-dir $OutputDir --base-url $BaseUrl --frontend-url $FrontendUrl --image $Image
